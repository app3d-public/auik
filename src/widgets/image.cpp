...
namespace auik
{
    ...
    namespace streams
    {
        extern AUIK_EXPORT const umbf::registry::BlockStream image{read_image, write_image};
        extern AUIK_EXPORT const umbf::registry::BlockStream checker_image{read_checker_image, write_checker_image};
    } // namespace streams
} // namespace auik
