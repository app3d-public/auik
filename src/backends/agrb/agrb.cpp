...
#include <auik/backends/agrb/quads_pipeline.hpp>
#include <auik/backends/agrb/textured_vertex_pipeline.hpp>
#include <auik/backends/agrb/textures_pipeline.hpp>
#include <auik/backends/agrb/vertex_pipeline.hpp>
...
namespace auik
{
    ...
    AUIK_EXPORT TextureID add_agrb_texture(vk::Sampler sampler, vk::ImageView image_view, vk::ImageLayout image_layout)
    {
