...
namespace auik::v2
{
    ...
    class APPLIB_API ModalWindow : public Window
    {
    public:
        ModalWindow(u32 id, acul::string title = "", const amal::rect &bounds = {},
    ...
    {
    public:
        explicit ModalQueue(u32 id, WidgetFlags widget_flags = get_default_modal_queue_flags(),
                            Widget *parent = nullptr);
        ~ModalQueue() override;

        void set_backdrop_color(const amal::vec4 &value);
        ...
        void set_modal_width(f32 value);
