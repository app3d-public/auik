...
namespace auik::v2
{
    ...
    class APPLIB_API TableTree final : public Widget
    {
    public:
        using Row = acul::vector<acul::string>;
        static constexpr size_t invalid_node = static_cast<size_t>(-1);
        ...
        void set_node_expanded(size_t node, bool expanded);
        bool node_expanded(size_t node) const;
        bool node_has_children(size_t node) const;
        ...
        bool is_row_hovered(size_t visible_row) const;
        bool is_arrow_hovered(size_t node) const;
