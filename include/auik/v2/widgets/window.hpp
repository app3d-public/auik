...
namespace auik::v2
{
    ...
    public:
        ...
        APPLIB_API void add_child(Widget *child, ChildLayoutFlags layout = default_child_layout_flags());
        APPLIB_API void add_children(const acul::vector<Widget *> &new_children);
        APPLIB_API void set_menu(MenuBar *menu);
        APPLIB_API Widget *take_menu_widget();
        APPLIB_API void set_menu_widget(Widget *menu);
        APPLIB_API void set_window_builder(WindowBuilder *builder);
        ...
        APPLIB_API bool is_popup_menu() const;
        APPLIB_API PopupMenu *header_popup_menu() const;
        ...
        virtual void back_hit_depth() override;
        virtual void restore_hit_depth() override;
    ...
    class APPLIB_API WindowBuilder : public Widget
    {
    public:
        using PFN_menu_suffix_create = acul::unique_function<void(WindowBuilder *, Window *, MenuBar *)>;

        explicit WindowBuilder(u32 id, Widget *parent = nullptr);
        ~WindowBuilder() override;
        ...
        void build_menu_suffix(Window *window, MenuBar *menu);
        ...
        void update_layout(bool min_size_known = true) override;
    ...
    inline Window *make_viewport_window(u32 id, const acul::string &title = "",
                                        ...
                                        Widget *parent = nullptr)
    {
        auto *window = acul::alloc<Window>(id, title, amal::rect{AUIK_POS_IGNORE, AUIK_SIZE_STRETCH},
                                           get_decorated_window_flags(), widget_flags, parent);
        window->set_rect_tag_id(AUIK_TAG_VIEWPORT_WINDOW);
        window->set_viewport_layout(ViewportLayoutMode::fill);
        return window;
    }
} // namespace auik::v2
