...
namespace auik
{
    class Checkbox final : public Widget, public umbf::Block
    {
    public:
        ...
        u32 signature() const noexcept override { return AUIK_TAG_CHECKBOX; }
    ...
    namespace streams
    {
        extern AUIK_EXPORT const umbf::registry::BlockStream checkbox;
    }
} // namespace auik
