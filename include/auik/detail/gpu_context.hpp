...
namespace auik::detail
{
    ...
    using PFN_clear_clip_rects_reallocated = void (*)(GPUContext *, u32);
    ...
    using PFN_invalidate_stream_data = void (*)(DrawStream *, DrawDataID, u32);
    ...
    struct StreamGPUDispatch
    {
        ...
        PFN_invalidate_stream_data invalidate_stream_data = nullptr;
    ...
    struct GPUContext
    {
        ...
        PFN_clear_clip_rects_reallocated clear_clip_rects_reallocated = nullptr;
